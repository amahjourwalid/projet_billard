...
## table of contents 
 ...
 2. Special depencies 
 3. Square case billar animation 
 4. Square case billar statistics 
...
### 3.Square case billard animation 
In order to see the animation please run "square case billard" code, a graphical user interface window will pop out, enter an angle press enter the click on start button. the result name and  an array containing the start angle, number of "V"s and number of "H"s will be returned.


### 4. Square case billard statistics 
To get some basic statistics on square case the billard please run all the code chunks in "square case billard statistics ".
the code returns: 
