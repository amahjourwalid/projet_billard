def outerFunction(a=2,b=1,x0,y0,m0, rebonds):     # notons que la fonction ne renvoie rien si le point n est pas dans l ellipse
...
outerFunction(a,b,1,0,3,12)


outerFunction(a,b,0,1,2,400)


outerFunction(a,b,-2,0,1,1000)  ## la trajectoire est delimitee par une nouvelle ellipse, le focal gauche n ayant pas ete croisee au  debut du mouvement            
